...
class XEmployeeDashboard(models.TransientModel):
    _name = 'igm.employee.dashboard'
    _description = 'Employee Workspace Engine'

    name = fields.Char(default="My Center")
    igm_field_service_count = fields.Integer(compute='_compute_field_service_tasks', string="Active Field Tasks")
    ...
    def _compute_field_service_tasks(self):
        ...
        for rec in self:
            rec.igm_field_service_count = count
